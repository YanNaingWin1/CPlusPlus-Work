...
// TEST_CASE("colorPicker::my basic censor", "[weight=1][part=colorPicker]") {
  
//   PNG imgtest;
//   imgtest.resize(6,4);

//   HSLAPixel *somepixel;
//   somepixel = imgtest.getPixel(0, 0);
//   *somepixel = HSLAPixel(30, 0.25, 0.75);

//   somepixel = imgtest.getPixel(1, 0);
//   *somepixel = HSLAPixel(120, 0.7, 0.4);

//   somepixel = imgtest.getPixel(2, 0);
//   *somepixel = HSLAPixel(40, 0.5, 0.2);

//   somepixel = imgtest.getPixel(3, 0);
//   *somepixel = HSLAPixel(60, 0.5, 0.25);

//   somepixel = imgtest.getPixel(4, 0);
//   *somepixel = HSLAPixel(240, 0.1, 0.8);

//   somepixel = imgtest.getPixel(5, 0);
//   *somepixel = HSLAPixel(200, 0.7, 0.5);

//   somepixel = imgtest.getPixel(0, 1);
//   *somepixel = HSLAPixel(100, 0.4, 0.4);

//   somepixel = imgtest.getPixel(1, 1);
//   *somepixel = HSLAPixel(180, 0.6, 0.2);

//   somepixel = imgtest.getPixel(2, 1);
//   *somepixel = HSLAPixel(80, 0.5, 0.9);

//   somepixel = imgtest.getPixel(3, 1);
//   *somepixel = HSLAPixel(130, 0.5, 0.2);

//   somepixel = imgtest.getPixel(4, 1);
//   *somepixel = HSLAPixel(218, 0.8, 0.1);

//   somepixel = imgtest.getPixel(5, 1);
//   *somepixel = HSLAPixel(45, 0.75, 0.75);

//   somepixel = imgtest.getPixel(0, 2);
//   *somepixel = HSLAPixel(220, 0.95, 0.15);

//   somepixel = imgtest.getPixel(1, 2);
//   *somepixel = HSLAPixel(282, 0.75, 0.15);

//   somepixel = imgtest.getPixel(2, 2);
//   *somepixel = HSLAPixel(310, 0.65, 0.35);

//   somepixel = imgtest.getPixel(3, 2);
//   *somepixel = HSLAPixel(164, 0.8, 0.25);

//   somepixel = imgtest.getPixel(4, 2);
//   *somepixel = HSLAPixel(110, 0.32, 0.55);

//   somepixel = imgtest.getPixel(5, 2);
//   *somepixel = HSLAPixel(178, 0.65, 0.95);

//   somepixel = imgtest.getPixel(0, 3);
//   *somepixel = HSLAPixel(34, 0.75, 0.25);

//   somepixel = imgtest.getPixel(1, 3);
//   *somepixel = HSLAPixel(265, 0.45, 0.15);

//   somepixel = imgtest.getPixel(2, 3);
//   *somepixel = HSLAPixel(5, 0.1, 0.8);

//   somepixel = imgtest.getPixel(3, 3);
//   *somepixel = HSLAPixel(50, 0.7, 0.25);

//   somepixel = imgtest.getPixel(4, 3);
//   *somepixel = HSLAPixel(250, 0.95, 0.35);

//   somepixel = imgtest.getPixel(5, 3);
//   *somepixel = HSLAPixel(300, 0.7, 0.8);

//   CensorColorPicker censorPicker(2, PixelPoint(CENSORX, CENSORY, HSLAPixel()), CENSORRADIUS, imgtest);

//   PNG result = testColorPicker(censorPicker);
//   result.writeToFile("images/myCensorColorPickerTest.png");
